...
import HeaderPage from "@/Base/HeaderPage.vue";
import FooterPage from "@/Base/FooterPage.vue";
import DrawerPage from "@/Base/DrawerPage.vue";
...
const {name, mdAndUp, smAndDown, smAndUp} = useDisplay()
